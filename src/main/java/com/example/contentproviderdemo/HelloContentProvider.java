...
public class HelloContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.example.contentproviderdemo.hellocontentprovider";
    ...
    static {
        //当你传过来的路径是content://com.example.contentproviderdemo.hellocontentprovider/person  匹配下面的
        uriMatcher.addURI(AUTHORITY, "person", MUTIPLE_CODE);
        //如果传过来的路径是content://com.example.contentproviderdemo.hellocontentprovider/person/1
        //#号是通配符
    ...
    //content://com.example.contentproviderdemo.hellocontentprovider/person/4
    @Nullable
    @Override
